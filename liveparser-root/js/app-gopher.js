...
var Temp_3 = GopherHelperF('>',1,2,'Temp_3','1','2');
var Temp_4 = GopherHelperF('>',2,3,'Temp_4','2','3');
var Temp_5 = GopherHelperF('||',Temp_1,Temp_2,'Temp_5','(numberA<numberB)','!(boolD)');
var Temp_6 = GopherHelperF('&&',Temp_3,Temp_4,'Temp_6','(1>2)','(2>3)');
var Temp_7 = GopherHelperF('!',Temp_5,null,'Temp_7','((numberA<numberB) || !(boolD))','');
var Temp_8 = GopherHelperF('||',Temp_6,Temp_7,'Temp_8','((1>2) && (2>3))','(!((numberA<numberB) || !(boolD)))');
var test1 = GopherSetF('test1','test1 = ( (((1>2) && (2>3)) || (!((numberA<numberB) || !(boolD)))) )',Temp_8,'=',true,'');
/*
...
var Temp_1 = GopherHelperF('!',boolB,null,'Temp_1','boolB','');
var Temp_2 = GopherHelperF('||',boolC,Temp_1,'Temp_2','boolC','! boolB');
var Temp_3 = GopherHelperF('!',Temp_2,null,'Temp_3','(boolC || ! boolB)','');
...
var Temp_1 = GopherHelperF('',cool,null,'Temp_1','cool','');
var Temp_2 = GopherHelperF('+',"hi ",Temp_1,'Temp_2','"hi "','cool()');
...
i = GopherSetF('i','i = 5+3+2+AddNumbers(i,j)',Temp_1,'=',true,'');
